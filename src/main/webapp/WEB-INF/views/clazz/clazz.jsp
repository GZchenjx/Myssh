...
<div id="tb">
    ...
    <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-edit" onclick="openWinWithData('list','editWin','editForm','clazz');">编辑</a>
    <div>
        <form id="searchForm">
...
<div id="addWin" class="easyui-window normal-win" title="添加班级" data-options="closed:true">
    <form id="addForm">
        <table>
            ...
            <tr>
                <td></td>
                <td><a class="easyui-linkbutton" href="javascript:void(0);" onclick="save('/clazz/save','addForm','list','addWin')">添加</a></td>
            </tr>
        </table>
    </form>
</div>
    ...
    <form id="editForm">
        ...
        <table>
            <tr>
                <td><label>名称</label></td>
                <td>
                    <input name="clazz.title" class="easyui-textbox easyui-validatebox" data-options="prompt:'请输入班级的名称',required:true,validType:'length[2,20]',novalidate:true"  />
                </td>
            </tr>

            <tr>
                <td></td>
                <td><a class="easyui-linkbutton" href="javascript:void(0);" onclick="update('/clazz/update','editForm','list','editWin')">修改</a></td>
            </tr>
        </table>
    </form>
</div>
