...
<div id="detailWin" class="easyui-window normal-win" title="学生详情" data-options="closed:true">
    <form id="editDetailForm">
        ...
        <table>
            ...
            <tr>
                <td><a class="easyui-linkbutton" href="javascript:void(0);" onclick="closeDetailWin();">取消</a></td>
                <td><a class="easyui-linkbutton" href="javascript:void(0);" onclick="update('/stuDetail/update', 'editDetailForm', 'list', 'detailWin')">修改</a></td>
            </tr>
        </table>
    </form>
</div>
