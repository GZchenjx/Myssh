...
<div id="menu" data-options="region:'west',split:true" title="主菜单">
    <div class="easyui-accordion">
        <div title="班级管理" data-options="iconCls:'icon-ok',selected:true">
            <ul>
                <li><a href="javascript:void(0);" class="site-navi-tab" data-src="<%=path %>/clazz/class_page">所有班级</a></li>
            </ul>
        </div>
        ...
        <div title="教师管理" data-options="iconCls:'icon-search'">
            ...
            <ul>
                <li><a href="javascript:void(0);" class="site-navi-tab" data-src="<%=path %>/teacher/teacher_page1">所有教师1</a></li>
