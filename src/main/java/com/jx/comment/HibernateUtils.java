...
public class HibernateUtils {
    ...
    public static <T> Long count(Session session, T t, String fieldName, Class<T> tClass) {
        CriteriaBuilder criteriaBuilder = session.getCriteriaBuilder();
        ...
        criteriaQuery.select(criteriaBuilder.count(root.get(fieldName)));
    ...
    public static <T> List<T> buildBean(List<Object[]> data, String[] array, Class<T> tClass) {
